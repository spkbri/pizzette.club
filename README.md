Benvenuti nel sorgente di [pizzette.club](https://pizzette.club/)!
...
Come mettere le password ai PDF
-------------------------------

Se avete Linux, usate il possente script `pubblica_pdf.sh` come indicato

```
./pubblica_pdf www/file_da_criptare.pdf PASSWORDSEGRETISSIMA
```

Se avete Windows, mi spiace.
